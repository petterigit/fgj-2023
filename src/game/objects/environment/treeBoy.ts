...
import { Actor, Animation, CollisionType, range, Shape, Vector } from 'excalibur';
import { CreateSpriteSheets } from 'game/types';

export const createTreeBoy = (spritesheets: CreateSpriteSheets) => (pos: Vector) => {

    const anim = Animation.fromSpriteSheet(spritesheets.treeBoy, range(0, 4), TreeBoyAnimationSpeed);
